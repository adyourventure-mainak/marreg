  ...
  return (
    <main className="min-h-screen bg-paper">
      <section className="page py-16 md:py-24">
        ...
        <div className="relative mx-auto mt-10 max-w-2xl overflow-hidden rounded-[2rem] bg-marreg-pink px-8 py-8 shadow-[0_20px_55px_rgba(184,50,106,.25)] md:mt-14 md:px-16">
